...
from app.api.routes.v1.user_setup.user import router as user_router

from app.api.routes.v1.organization import (
...
from app.api.routes.v1.user_setup.permission import router as permission_router
