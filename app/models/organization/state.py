...
class State(Document, TimeStampMixin):
    ...
    ] = Field(..., description="State name (unique, case-insensitive)")

    code: Annotated[
        str,
        Indexed(unique=True, name="state_model_code"),
    ] = Field(...)

    country_id: Annotated[
        PydanticObjectId,
        Indexed(
            name="state_model_country_id",
        ),
